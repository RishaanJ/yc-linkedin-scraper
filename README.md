...
No third-party dependencies — just Python 3 and the standard library.
...
1. Fetches the YC companies directory page and reads the Algolia app ID/API key from `window.AlgoliaOpts`.
